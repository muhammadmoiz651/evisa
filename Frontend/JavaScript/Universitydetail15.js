document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch('/api/details')
    ...
    .then((data) => {
      if (data.length > 0) {
        const university = data[14]; // Assuming you want the first university for demonstration
  ...
  <span class="stat-label">
    <a 
      href="https://www.upm.es/internacional/UPM/UPM_Channel/News?id=CON12281&fmt=detail&prefmt=articulo#:~:text=The%20Universidad%20Polit%C3%A9cnica%20de%20Madrid%20(UPM)%20ranked%20321%20in%20the,in%20the%20top%2022%25%20worldwide." 
      target="_blank" 
...
`;
        ...
        const undergradPrograms = programs.slice(0, 16);
        const masterPrograms = programs.slice(16);
