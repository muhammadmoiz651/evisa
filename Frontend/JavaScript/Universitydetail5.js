document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch('/api/details')
    ...
    .then((data) => {
      if (data.length > 0) {
        const university = data[4]; // Assuming you want the first university for demonstration
  ...
  <span class="stat-label">
    <a 
      href="https://www.ub.edu/school-economics/the-university-of-barcelona-climbs-15-places-in-the-qs-world-university-rankings/" 
      target="_blank" 
