document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch('/api/details')
    ...
    .then((data) => {
      if (data.length > 0) {
        const university = data[9]; // Assuming you want the first university for demonstration
  ...
  <span class="stat-label">
    <a 
      href="https://www.timeshighereducation.com/world-university-rankings/universitat-politecnica-de-catalunya" 
      target="_blank" 
...
`;
        ...
        const undergradPrograms = programs.slice(0, 15);
        const masterPrograms = programs.slice(15);
