document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch('/api/details')
    ...
    .then((data) => {
      if (data.length > 0) {
        const university = data[8]; // Assuming you want the first university for demonstration
  ...
  <span class="stat-label">
    <a 
      href="https://www.topuniversities.com/universities/universidad-autonoma-de-madrid#:~:text=you%20into%20university?-,Rankings%20&%20Ratings,QS%20World%20University%20Rankings%202025." 
      target="_blank" 
...
`;
        ...
        const undergradPrograms = programs.slice(0, 5);
        const masterPrograms = programs.slice(5);
