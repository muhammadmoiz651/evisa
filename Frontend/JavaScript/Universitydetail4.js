document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch('/api/details')
    ...
    .then((data) => {
      if (data.length > 0) {
        const university = data[3]; // Assuming you want the first university for demonstration
  ...
  <span class="stat-label">
    <a 
      href="https://www.lmu.de/en/about-lmu/lmu-at-a-glance/facts-and-figures/lmu-in-rankings/#:~:text=not%20yet%20published-,%2359%20worldwide,-%2354%20worldwide" 
      target="_blank" 
