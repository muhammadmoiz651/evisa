async function fetchScholarshipData() {
  try {
    ...
    if (data && Array.isArray(data) && data.length > 0) {
      ...
      const applyLink = 'https://web.berlinsbi.com/generic-barcelona-affiliates?utm_source=globalscholarships.com&utm_medium=affiliate&utm_campaign=b:bsbi-bar-cv-listing'; 
