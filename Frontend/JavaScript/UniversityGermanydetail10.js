document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch('/api/details')
    ...
    .then((data) => {
      if (data.length > 0) {
        const university = data[19]; // Assuming you want the first university for demonstration
  ...
  <span class="stat-label">
    <a 
      href="https://www.munich-business-school.de/insights/en/2018/mbs-ranked-for-the-first-time-in-qs-world-university-rankings/" 
      target="_blank" 
...
`;
        ...
        const undergradPrograms = programs.slice(0, 2);
        const masterPrograms = programs.slice(2);
