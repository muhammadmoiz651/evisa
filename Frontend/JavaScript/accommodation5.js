...
fetch('/api/accommodations')
  ...
  .then(data => {
    const accommodation = data.find(acc => acc.accommodation_id === 4);
    ...
    if (accommodation) {
      ...
      const locationEllll = document.querySelector('.accommodation-locationsss');
      if (locationEllll) locationEllll.textContent = accommodation.location;
