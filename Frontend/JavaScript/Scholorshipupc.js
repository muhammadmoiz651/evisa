async function fetchScholarshipData() {
  try {
    ...
    if (data && Array.isArray(data) && data.length > 0) {
      ...
      const applyLink = 'https://www.upc.edu/sri/en/mobility_office/students-mobility-office/incomings/studying-at-the-upc/copy_of_scholarships#:~:text=I'; 
