...
const targetVisaId = 2;  // Target specific Visa by ID
    ...
    if (visa) {
      ...
      visaCard.innerHTML = `
        ...
        <div class="country-links">
          ...
          <a href="${visa.info_link}" target="_blank" class="info-btn">Application form</a>
          <a href="https://sutramiteconsular.maec.es/Home.aspx" target="_blank" class="info-btn">Application Status</a>
        </div>
      `;
