document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch('/api/details')
    ...
    .then((data) => {
      if (data.length > 0) {
        const university = data[12]; // Assuming you want the first university for demonstration
  ...
  <span class="stat-label">
    <a 
      href="https://u-paris.fr/en/universite-paris-cite-ranked-among-the-40-top-universities-in-the-world/" 
      target="_blank" 
      rel="noopener noreferrer"
      class="qs-link"
    >
      Top University Ranking in the World
    </a>
  </span>
</div>
          <div class="stat-item">
