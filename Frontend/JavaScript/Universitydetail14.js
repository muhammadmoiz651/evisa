document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch('/api/details')
    ...
    .then((data) => {
      if (data.length > 0) {
        const university = data[13]; // Assuming you want the first university for demonstration
  ...
  <span class="stat-label">
    <a 
      href="https://www.uni-mannheim.de/en/about/profile/rankings/#:~:text=QS%20World%20University%20Rankings%20by,in%20Germany%20again%20in%202025." 
      target="_blank" 
...
`;
        ...
        const undergradPrograms = programs.slice(0, 6);
        const masterPrograms = programs.slice(6);
