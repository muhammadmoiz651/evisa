document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch('/api/details')
    ...
    .then((data) => {
      if (data.length > 0) {
        const university = data[7]; // Assuming you want the first university for demonstration
  ...
  <span class="stat-label">
    <a 
      href="https://www.univ-grenoble-alpes.fr/about/uga-in-numbers/international-rankings/universite-grenoble-alpes-in-international-rankings-784640.kjsp" 
      target="_blank" 
      rel="noopener noreferrer"
      class="qs-link"
    >
     French Higher University Ranking
    </a>
  </span>
</div>
          <div class="stat-item">
  ...
  <div class="accordion-group">
    ...
    <div class="accordion-header" id="engineeringHeading">
      Engineering & Applied Science Programs
      <span class="icon" id="engineeringIcon">+</span>
    </div>
    <div id="engineeringContainer" class="program-list" style="display: none;"></div>

    <div class="accordion-header" id="doctoralHeading">
      Doctoral Programs
      <span class="icon" id="doctoralIcon">+</span>
    </div>
    <div id="doctoralContainer" class="program-list" style="display: none;"></div>
  </div>
`;
        ...
        const engineeringContainer = document.getElementById("engineeringContainer");
        ...
        const undergradPrograms = [
          ...
          "Bachelor's in International Business and Management",
          "DUT in Civil Engineering and Sustainable Construction",
          "BUT in Civil Engineering and Sustainable Construction",
          "Professional Bachelor's in Computer Networks and Telecommunication"
        ];
        ...
        const masterPrograms = [
          ...
          "Master's in Corporate Management and Administration"
        ];
        ...
        const engineeringPrograms = [
          ...
          "Polytech Grenoble - Various Engineering Disciplines"
        ];
        ...
        const doctoralPrograms = [
          ...
          "Doctoral Programs in Humanities and Social Sciences"
        ];

        // Function to add programs to containers
        function addPrograms(container, programs) {
          programs.forEach(program => {
            container.innerHTML += `<div class="program-item">${program}</div>`;
          });
          container.innerHTML += `
  ...
  `;
        ...
        // Add programs to each container
        addPrograms(undergradContainer, undergradPrograms);
        addPrograms(masterContainer, masterPrograms);
        addPrograms(engineeringContainer, engineeringPrograms);
        addPrograms(doctoralContainer, doctoralPrograms);
        ...
        document.getElementById("engineeringHeading").addEventListener('click', () => {
          toggleAccordion('engineeringContainer', 'engineeringIcon');
        });
        document.getElementById("doctoralHeading").addEventListener('click', () => {
          toggleAccordion('doctoralContainer', 'doctoralIcon');
        });
