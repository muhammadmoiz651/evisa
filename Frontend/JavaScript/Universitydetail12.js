document.addEventListener("DOMContentLoaded", function () {
  ...
  fetch('/api/details')
    ...
    .then((data) => {
      if (data.length > 0) {
        const university = data[11]; // Assuming you want the first university for demonstration
  ...
  <span class="stat-label">
    <a 
      href="https://www.uni-heidelberg.de/en/research/research-profile/heidelberg-university-in-international-comparison" 
      target="_blank" 
...
`;
        ...
        const undergradPrograms = programs.slice(0, 17);
        const masterPrograms = programs.slice(17);
